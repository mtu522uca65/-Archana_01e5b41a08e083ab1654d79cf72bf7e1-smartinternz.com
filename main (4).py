'''Implement a class called player that represents a cricket player .The player class have a
method called play() which prints "The player is playing cricket" derive two classes, batsman and
Bowler, from the player class.override the play() method in each derived class to print "batsman
